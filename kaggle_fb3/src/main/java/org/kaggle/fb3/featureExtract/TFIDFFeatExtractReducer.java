 ...
 * 
 * @author Chit
 * <Reducer-in> [tag - title+body - noOfTicket = 1 -  tagContains = 0/1]    # content is cleaned and bi-grammed
 * <Reducer-out> [tag - title+body - noOfTicket -  tagContains] # all the content,noOfTicket,keyContains  combined
 *
 */
